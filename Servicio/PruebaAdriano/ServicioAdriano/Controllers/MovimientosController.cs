...
using DatosAdriano.Utils;
using DatosAdriano.ViewModels;
...
namespace ServicioAdriano.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MovimientosController : ControllerBase
    {
        private readonly AdrianoBaseContext _context;
        public MovimientosController(AdrianoBaseContext context)
        {
            _context = context;
        }
        [HttpGet]
        ...
        public async Task<Respuesta> PostPMovimiento(Movimiento pMovimiento)
        {
            ...
            if (string.Equals(pMovimiento.MoTipoMovimiento, Utilidades.strDebito))
            {
        ...
        public async Task<Respuesta> ValidarCupos(string strNumeroCuenta, decimal decMontoTransaccion)
        {
            ...
            decimal valoresRetiro = await _context.Movimientos
                ...
                && x.MoTipoMovimiento == Utilidades.strDebito)
            ...
            if (totalsupuesto > Utilidades.Valor_Tope || totalsupuesto > Utilidades.Valor_Tope)
            {
